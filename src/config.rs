...
pub const RENDEZVOUS_SERVERS: &[&str] = &["47.94.240.154"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 56736;
pub const RELAY_PORT: i32 = 56737;
pub const WS_RENDEZVOUS_PORT: i32 =56738;
pub const WS_RELAY_PORT: i32 = 56739;
