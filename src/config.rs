...
pub const RENDEZVOUS_SERVERS: &[&str] = &["202.79.169.168"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 51736;
pub const RELAY_PORT: i32 = 51737;
pub const WS_RENDEZVOUS_PORT: i32 =51738;
pub const WS_RELAY_PORT: i32 = 51739;
