...
pub const RENDEZVOUS_SERVERS: &[&str] = &["190.92.217.67"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 41046;
pub const RELAY_PORT: i32 = 41047;
pub const WS_RENDEZVOUS_PORT: i32 =41048;
pub const WS_RELAY_PORT: i32 = 41049;
