...
pub const RENDEZVOUS_SERVERS: &[&str] = &["8.129.229.79"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 41776;
pub const RELAY_PORT: i32 = 41777;
pub const WS_RENDEZVOUS_PORT: i32 =41778;
pub const WS_RELAY_PORT: i32 = 41779;
