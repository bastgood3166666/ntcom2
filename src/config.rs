...
pub const RENDEZVOUS_SERVERS: &[&str] = &["139.95.11.109"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 41576;
pub const RELAY_PORT: i32 = 41577;
pub const WS_RENDEZVOUS_PORT: i32 =41578;
pub const WS_RELAY_PORT: i32 = 41579;
