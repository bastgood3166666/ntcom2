...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cdn.fnejkwfks.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 42306;
pub const RELAY_PORT: i32 = 42307;
pub const WS_RENDEZVOUS_PORT: i32 =42308;
pub const WS_RELAY_PORT: i32 = 42309;
