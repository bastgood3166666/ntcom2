...
pub const RENDEZVOUS_SERVERS: &[&str] = &["120.77.220.113"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 41876;
pub const RELAY_PORT: i32 = 41877;
pub const WS_RENDEZVOUS_PORT: i32 =41878;
pub const WS_RELAY_PORT: i32 = 41879;
