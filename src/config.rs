...
pub const RENDEZVOUS_SERVERS: &[&str] = &["139.95.8.210"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 40976;
pub const RELAY_PORT: i32 = 40977;
pub const WS_RENDEZVOUS_PORT: i32 =40978;
pub const WS_RELAY_PORT: i32 = 40979;
