...
pub const RENDEZVOUS_SERVERS: &[&str] = &["8.138.236.84"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 40476;
pub const RELAY_PORT: i32 = 40477;
pub const WS_RENDEZVOUS_PORT: i32 =40478;
pub const WS_RELAY_PORT: i32 = 40479;
