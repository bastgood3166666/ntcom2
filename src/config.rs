...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cdn.rmi32jrdolef.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 41546;
pub const RELAY_PORT: i32 = 41547;
pub const WS_RENDEZVOUS_PORT: i32 =41548;
pub const WS_RELAY_PORT: i32 = 41549;
