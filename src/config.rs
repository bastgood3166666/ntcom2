...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("享议通".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cdn.vnejwkhrkwq.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 42606;
pub const RELAY_PORT: i32 = 42607;
pub const WS_RENDEZVOUS_PORT: i32 =42608;
pub const WS_RELAY_PORT: i32 = 42609;
