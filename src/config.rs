...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("享议宝".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cdn.dsgmi324jtrolds.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 42506;
pub const RELAY_PORT: i32 = 42507;
pub const WS_RENDEZVOUS_PORT: i32 =42508;
pub const WS_RELAY_PORT: i32 = 42509;
