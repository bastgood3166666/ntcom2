...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cdn.fnjkhrkew.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 41906;
pub const RELAY_PORT: i32 = 41907;
pub const WS_RENDEZVOUS_PORT: i32 =41908;
pub const WS_RELAY_PORT: i32 = 41909;
