...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cdn.dshd34fkds.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 42706;
pub const RELAY_PORT: i32 = 42707;
pub const WS_RENDEZVOUS_PORT: i32 =42708;
pub const WS_RELAY_PORT: i32 = 42709;
