...
pub const RENDEZVOUS_SERVERS: &[&str] = &["39.97.165.89"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 56836;
pub const RELAY_PORT: i32 = 56837;
pub const WS_RENDEZVOUS_PORT: i32 =56838;
pub const WS_RELAY_PORT: i32 = 56839;
