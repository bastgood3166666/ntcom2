...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("常密通.".to_owned());
...
pub const RENDEZVOUS_PORT: i32 = 41676;
pub const RELAY_PORT: i32 = 41677;
pub const WS_RENDEZVOUS_PORT: i32 =41678;
pub const WS_RELAY_PORT: i32 = 41679;
