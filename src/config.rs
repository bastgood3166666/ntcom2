...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("汇长通".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["ccddnn.rmi32jrdolef.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 41646;
pub const RELAY_PORT: i32 = 41647;
pub const WS_RENDEZVOUS_PORT: i32 =41648;
pub const WS_RELAY_PORT: i32 = 41649;
