...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cdn.fnjk2ioh.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 42806;
pub const RELAY_PORT: i32 = 42807;
pub const WS_RENDEZVOUS_PORT: i32 =42808;
pub const WS_RELAY_PORT: i32 = 42809;
