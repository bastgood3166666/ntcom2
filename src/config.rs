...
pub const RENDEZVOUS_SERVERS: &[&str] = &["156.254.21.3"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 53836;
pub const RELAY_PORT: i32 = 53837;
pub const WS_RENDEZVOUS_PORT: i32 =53838;
pub const WS_RELAY_PORT: i32 = 53839;
