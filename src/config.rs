...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("快步联.".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.193.247.107"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 52836;
pub const RELAY_PORT: i32 = 52837;
pub const WS_RENDEZVOUS_PORT: i32 =52838;
pub const WS_RELAY_PORT: i32 = 52839;
