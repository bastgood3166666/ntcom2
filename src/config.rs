...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cdn.gdmktj3wlef.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 41746;
pub const RELAY_PORT: i32 = 41747;
pub const WS_RENDEZVOUS_PORT: i32 =41748;
pub const WS_RELAY_PORT: i32 = 41749;
