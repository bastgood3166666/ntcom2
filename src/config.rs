...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cdn.f32jrikjew.top"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 41346;
pub const RELAY_PORT: i32 = 41347;
pub const WS_RENDEZVOUS_PORT: i32 =41348;
pub const WS_RELAY_PORT: i32 = 41349;
