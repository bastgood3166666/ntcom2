...
pub const RENDEZVOUS_SERVERS: &[&str] = &["1.14.161.217"];
pub const RS_PUB_KEY: &str = "gRP1LZ3P4dMEatpfCA4qfNVTETTCmmn7cPkK+uX3HVk=";
pub const RENDEZVOUS_PORT: i32 = 54936;
pub const RELAY_PORT: i32 = 54937;
pub const WS_RENDEZVOUS_PORT: i32 =54938;
pub const WS_RELAY_PORT: i32 = 54939;
